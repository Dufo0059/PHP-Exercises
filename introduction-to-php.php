...
echo "<br><li>CSS - Stands for Cascading Stylesheet</li>";
echo "<br><li>JS - Stands for JavaScript</li>";
echo "<br><li>PHP - Stands for Hypertext Preprocessor</li>";
echo "<br><li>SQL - Stands for Structural Query Language</li></ul>";
